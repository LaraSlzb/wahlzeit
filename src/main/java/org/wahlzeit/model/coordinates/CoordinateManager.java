...
public class CoordinateManager {
    ...
    public static HashMap<String, CartesianCoordinate> allCartesianCoordinate = new HashMap<>();
    public static HashMap<String, SpericCoordinate> allSpericCoordinate = new HashMap<>();

    /**
     * Unifies doubles to a specific format
     */
    protected static double unifyDouble(double d){
     ...
     */
    protected static String getKeyCartesian(double x, double y, double z){
     ...
     */
    protected static String getKeySperic(double latitude, double longitude, double radius){
